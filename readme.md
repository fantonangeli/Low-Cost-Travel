...
THIS PROJECT HAS BEEN ABANDONED ON 2009 AND NOT MAINTEINED!

This is Firefox extension finds for the best airfare on different websites.
...
you should do the following:
  ...
  2. Put the full path to the folder (e.g. c:\dev\lowcosttravel on
     Windows, /home/user/dev/lowcosttravel on Linux) in a file named
     fabrizio.antonangeli@gmail.com and copy that file to
